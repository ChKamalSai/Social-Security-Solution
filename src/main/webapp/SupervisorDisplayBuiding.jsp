...
<head>
<meta charset="UTF-8">
<title>Display Building Details</title>
<style>
body {
...
<div class="header">
   ...
   <div class="container">
<div class="searchbar">
<input type="text" id="searchInput" placeholder="Search for Building Name" oninput="searchItems()">
</div>
<div class="dropdown">
...
<% 
		...
		try(Connection con=DriverManager.getConnection(url,user,paswd)){
			PreparedStatement prp=con.prepareStatement("select * from Building_Details");
			...
			while(rs.next()){
				...
				int NumOfFloors=rs.getInt(3);
				int FlatsPerFloor=rs.getInt(4);
				int TotalFlats=rs.getInt(5);
				%>
				<tr>
					<td><%=BuildingName %></td>
					<td><%=Location %></td>
