...
<div class="login-form">
            ...
            <form action="" method="post">
                    ...
                    <label>Mobile Number:</label>
                   	...
                   	<label>Work:</label>
                    <input type="text" name="Work" pattern="^[a-zA-Z]{1,20}$" title ="max 20 characters and only alphabets"  required>
                    <br><br>
...
<% 
		...
		try(Connection con=DriverManager.getConnection(url,user,paswd)){
			...
			PreparedStatement prp =con.prepareStatement("Insert into RegularVisitor_Details(SecurityCode,Name,Mobile,Work) values (?,?,?,?)") ;
			int b=0;
			int Code=0;
					while(b==0){
			PreparedStatement prp1=con.prepareStatement("Select * from RegularVisitor_Details");
			ResultSet rs=prp1.executeQuery();
			Random k=new Random();
			Code=100000+k.nextInt(899999);
			...
			prp.executeUpdate();
			String a="<script>alert('Succesfully Added. Your security code is:"+Code+"')</script>";
			out.println(a);
