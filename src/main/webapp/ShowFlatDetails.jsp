...
<head>
<meta charset="UTF-8">
<title>Display Flat Details</title>
<style>
body {
...
<% 
		...
		try(Connection con=DriverManager.getConnection(url,user,paswd)){
			PreparedStatement prp=con.prepareStatement("select * from Flat_Details Order by BuildingName");
			...
			while(rs.next()){
				...
				String FlatType=rs.getString(3);
				%>
				<tr>
				<td><%=FlatNo %></td>
				<td><%=BuildingName%></td>
