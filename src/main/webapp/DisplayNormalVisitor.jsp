...
<head>
<meta charset="UTF-8">
<title>Display Normal Visitor Details</title>
<style>
body {
...
<% 
		...
		try(Connection con=DriverManager.getConnection(url,user,paswd)){
			PreparedStatement prp=con.prepareStatement("select * from NormalVisitor_Details order by CheckOut is Null , CheckOut Desc ");
			...
			while(rs.next()){
				...
				String BuildingName=rs.getString(5);
