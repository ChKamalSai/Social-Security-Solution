...
<head>
<meta charset="UTF-8">
<title>Display Staff Details</title>
<style>
body {
...
<% 
		...
		try(Connection con=DriverManager.getConnection(url,user,paswd)){
			PreparedStatement prp=con.prepareStatement("select * from Staff_Details order by Post");
			...
			while(rs.next()){
				...
				<tr>
					...
					<td><%=Post %></td>
					<td><%=Mobile%></td>
					<td><form action="UpdateStaffDetails.jsp" method="post">
